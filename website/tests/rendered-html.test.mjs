...
test("renders the Tapioca documentation homepage", async () => {
  ...
  assert.match(html, /On your machine\./);
  assert.match(html, /A good place to start\./);
  assert.match(html, /tapioca-desktop-ui\.png/);
  assert.match(html, /x64 and ARM64/);
  assert.match(html, /local API/);
  assert.match(html, /tapioca run qwen3:4b-q4_k_m/);
  assert.match(html, /Import &amp; transfer/i);
  assert.match(html, /Your machine, your choice\./);
  assert.match(html, /tapioca catalog update/i);
  assert.match(html, /tapioca update --check/i);
  assert.match(html, /Questions, ideas, and creations welcome\./i);
  assert.match(html, /Join Discord/i);
  assert.match(html, /https:\/\/discord\.gg\/vkFpNvY2ZY/);
  assert.match(html, /Apache-2\.0/);
  assert.match(html, /href="\/learn#images"/);
  assert.match(html, /href="\/learn#voice"/);
